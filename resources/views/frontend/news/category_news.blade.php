...
<div class="content-details">{!! Str::limit($item->news_details,100) !!}<a href=" "> Read More </a>
</div>
</div>
</div>
</div>
...
<a href=" "><img class="lazyload" src="{{ asset($item->image)}}"  ></a> <div class="archive1-meta">
<a href=" "><i class="la la-tags"> </i>
{{ $item->created_at->format('1 M d Y')}}
</a>
</div>
