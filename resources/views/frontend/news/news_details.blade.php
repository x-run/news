    ...
    <div class="row">
        <div class="col-lg-8 col-md-8">
            ...
            <div class="single-page-social">
                ...
                <a onclick="printFunction()" target="_blank"><i class="las la-print"></i></a>
            </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="contact-form">
                                <span class="wpcf7-form-control-wrap news_details">
                                    <textarea name="news_details" cols="20" rows="5" class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="News Details...."></textarea>
                                </span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="archiveTab-sibearNews">
                            @foreach($newnewspost as $key=> $newsitem)
                                <div class="archive-tabWrpp archiveTab-border">
                                    ...
                                    <h4 class="archiveTab_hadding"><a href="{{ url('news/details/'.$newsitem->id.'/'.$newsitem->news_title_slug) }}">{{ $newsitem->newstitle}} </a></h4>
