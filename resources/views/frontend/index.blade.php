...
<div class="col-lg-4 col-md-4">
<h2 class="themesBazar_cat01"> <a href="{{ url('news/category/'.$skip_cat_4->id.'/'.$skip_cat_4->category_slug) }}"> {{ $skip_cat_4->category_name }}</a> <span> <a href="{{ url('news/category/'.$skip_cat_4->id.'/'.$skip_cat_4->category_slug) }}"> More <i class="las la-arrow-circle-right"></i> </a></span> </h2>
