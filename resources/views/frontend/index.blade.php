...
<a href="{{ url('news/details/'.$slider->id.'/'.$slider->news_title_slug) }}">{{ GoogleTranslate::trans($slider->news_title, app()->getLocale()) }}</a>
</h1>
</div>
</div></div>
@endforeach
...
<a href="{{ url('news/details/'.$nine->id.'/'.$nine->news_title_slug)}} ">{{ GoogleTranslate::trans($nine->news_title, app()->getLocale()) }}</a>
</h4>
</div>
<div class="cat-meta">
