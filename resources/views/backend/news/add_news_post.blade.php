                    ...
                    <form id="myForm" method="post" action="{{ route('admin.store')}}">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-check mb-2 form-check-primary">
                                    <input type="checkbox" class="form-check-input" value="1" name="top_slider" id="customcheck1">
                            ...
                            <div class="col-lg-6">
                                <div class="form-check mb-2 form-check-danger">
                                    <input type="checkbox" class="form-check-input" value="1" name="first_section_three" id="customcheck1">
                                    <label for="customcheck3" class="form-check-label">First Section Three</label>
                                </div>

                                <div class="form-check mb-2 form-check-danger">
                                    <input type="checkbox" class="form-check-input" value="1" name="first_section_nine" id="customcheck1">
